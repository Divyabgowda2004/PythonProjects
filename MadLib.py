...
def Story1(win):
    def final(tl: Toplevel, name, sports, City, playername, drinkname, snacks):
        ...
        But we were not able to play. So, we went to watch the game and our favourite player
        {playername}. We drank {drinkname} and also ate some {snacks} We really enjoyed it! We
        are looking forward to go again and enjoy
        '''
...
#creating buttons
Story1Button = Button(Screen, text='A memorable day', font=("Times New Roman", 10),command=lambda: Story1(Screen),bg='pink')
Story1Button.place(x=130, y=90)
Story2Button = Button(Screen, text='Ambitions', font=("Times New Roman", 10),command=lambda: Story2(Screen), bg='pink')
